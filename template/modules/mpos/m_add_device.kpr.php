<div id="page-content">
 ...
 ?>
                                    ...
                                    <div class="block-title">
                                        <h2><strong>Add Device</strong></h2>
                                    </div>
                                    ...
                                    <form id="form-validation" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <label class="col-md-4 control-label" for="serial_no">Enter Serial Number</label>
                                            <div class="col-md-7">
                                                <input type="text" id="serial_no" name="serial_no" class="form-control" placeholder="Enter Serial Number">
                                        ...
                                        <hr style="border:1px dashed #eaedf1;width: 100%;">
                                            ...
                                            <div class="form-group col-sm-6 col-xs-12">
                                            <label class="col-md-4 control-label" for="rent">Enter Rent</label>
                                            <div class="col-md-7">
                                                <input type="text" id="rent" name="rent" class="form-control" placeholder="Enter Rent">
                                               
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label class="col-md-4 control-label" for="rent">Enter Remark</label>
                                            <div class="col-md-7">
          ...
          <hr style="border:1px dashed #eaedf1;width: 100%;">
                                        ...
                                        <div class="form-group form-actions button_margin123">
                                            <div class="col-md-12">
                                                <center><button type="submit" name="addmpos" class="btn btn-sm btn-primary"><i class="fa fa-arrow-right"></i> Submit</button>
