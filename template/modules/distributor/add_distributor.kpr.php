<div id="page-content">
                        ...
                        <ul class="breadcrumb breadcrumb-top">
                            <li> Distributor</li>
                            <li><a href="">Add Distributor</a></li>
                        </ul>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2><strong>Add Distributor</strong></h2>
                                    </div>
                                           ...
                                           <hr style="border:1px dashed #eaedf1;width: 100%;">
                                            ...
                                            <div class="form-group col-md-6 col-xs-12">
                                                <label class="col-md-4 col-xs-12 control-label" for="firstname">First Name</label>
                                                    ...
                                                    <div class="col-md-7 col-xs-11 input-group">
                                                        <input type="text" id="firstname" name="firstname" class="form-control forn_control12" placeholder="First Name">
                                            ...
                                            <div class="form-group col-md-6 col-xs-12">
                                                <label class="col-md-4 col-xs-12 control-label" for="lastname">Last Name</label>
                                                    ...
                                                    <div class="col-md-7 col-xs-11 input-group">
                                                        <input type="text" id="last_name" name="lastname" class="form-control forn_control12" placeholder="Last Name">
                                        ...
                                        <div class="col-md-7 col-xs-12">
                                            <div class="prod_bord1">
                                                ...
                                                <div class="hover_ad1 ">
                                                    <div class="fileUpload btn">
                                                        <span style="color:#fff;">Upload</span>
                                                        <input required id="uploadPhoto1" type="file" accept="image/*" name="pan_card"  class="upload pan_card" onchange="readURL1(this);">
