                                ...
                                <div class="block">
                                    ...
                                    <form id="form-validation" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <label class="col-md-4 control-label" for="example-text-input">Enter Adsense</label>
                                            <div class="col-md-7">
                                                <input type="text" id="example-text-input" name="example-text-input" class="form-control" placeholder="Enter Adsense">
