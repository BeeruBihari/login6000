                                ...
                                <div class="block">
                                    ...
                                    <form id="form-validation" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="form-group col-md-6 col-xs-12">
                                            <label class="col-md-4 control-label" for="example-textarea-input">Bulk SMS Detail</label>
                                            <div class="col-md-7">
                                                <textarea id="example-textarea-input" name="example-textarea-input" rows="5" class="form-control" placeholder="Content.."></textarea>
                                            </div>
                                        </div>
