                      ...
                      <form method="post">
                                   ...
                                   <div class="col-sm-2 col-xs-5">
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-2">
                                            <input type="text" id="example-datepicker" name="example-datepicker" class="form-control input-datepicker" data-date-format="mm/dd/yy" placeholder="To Date">
                                    </div>
                                        ...
                                        <div class="" id="example-datatable_length">
                                            <label>
                                                <select name="example-datatable_length" aria-controls="example-datatable" class="form-control">
                                                    ...
                                                    <option value="30">SRS1</option>
                                                    <option value="30">TestAPI</option>
