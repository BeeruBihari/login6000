                                    ...
                                    <form id="form-validation" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="form-group col-md-6 col-xs-12">
                                                <label class="col-md-4 col-xs-12 control-label" for="ad_mnt">Ad management Detail</label>
                                               
                                                    <div class="col-md-7 col-xs-11 input-group">
                                                        <input required type="text" value="" id="ad_mnt" name="ad_mnt" class="form-control forn_control12" placeholder="Ad management Detail">
