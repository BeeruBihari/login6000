...
<div id="page-content">
                            ...
                            <div class="block-title">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-10">
                                        ...
                                        <h2><strong></strong> DMT Slab List</h2>
           ...
           foreach ($get_dmt_slab_up as $grp):
               if($grp['dmt_type'] == 2){
                 $dmttype = 'DMT Variable'; 
               }
               else{
                   $dmttype = 'DMT Flat';
               }
	...
	<div class="row">
		<div class="span12">
                ...
                <form id="form-validation" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                     ...
                     <div class="col-sm-6 form-group">
                         <label class="col-md-4 control-label" for="">DMT Type</label>
                         <div class="col-md-7">
                             <select id="api_holder" name="dmt_type" class="form-control" size="1" required>
                                 <!--<option value="1">DMT Flat</option>-->
                                   <option value="2">DMT Variable</option>
                     ...
                     <div class="col-sm-6 form-group">
                         <label class="col-md-4 control-label" for="">Surecharge</label>
                         <div class="col-md-7">
                              <input type="text" id="url" name="coms" class="form-control" placeholder="Commission" required>
                         </div>
                     </div>
                        <div class="col-sm-6 form-group">
                         <label class="col-md-4 control-label" for="">Surecharge Type</label>
                         <div class="col-md-7">
			...
			<hr style="border:1px dashed #eaedf1;width: 100%;">
                                        ...
                                        <div class="form-group form-actions button_margin123" >
                                            <div class="col-md-12" style="margin-bottom:3%;">
                                                <center><button type="submit" name="add_dmt_slab" class="btn btn-sm btn-primary"><i class="fa fa-arrow-right"></i> Submit</button>
     ...
     function imageshow(input,i) {
            ...
            <table class="table table-borderless table-striped table-vcenter table-bordered">
                ...
                <tbody>
                       ...
                       <?php
            $i = 1;
            //print_r($get_dmt_slab);
           foreach ($get_dmt_slab as $grp):
               if($grp['dmt_type'] == 2){
                 $dmttype = 'DMT Variable'; 
               }
               else{
