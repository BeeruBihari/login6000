...
<div id="page-content">
                            ...
                            <div class="block-title">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-10">
                                        ...
                                        <h2><strong>API SMS Report</strong> </h2>
                     ...
                     <form method="post">
                                    ...
                                    <div class="col-sm-1 col-xs-6" style="margin-left:1%;">
                                     ...
                                     <div class="col-sm-2 col-xs-5" >
                                        ...
                                        <div class="" id="example-datatable_length">
                                            <label>
                                                <select name="example-datatable_length" aria-controls="example-datatable" class="form-control">
                                                    <option value="10">From Mobile</option>
                                                    <option value="20">To Mobile</option>
                                                    <option value="21">Message</option>
