   <script src="<?php echo Fjs; ?>/vendor/jquery.min.js"></script>
    ...
    <div id="page-content">
                                         ...
                                         <div class="col-xs-12 col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-4">
                                                   <div class="form-group">
                                                 <label class="col-md-3 control-label" for="val_date">From</label>
                                                ...
                                                <div class="col-xs-12 col-sm-4">
                                                    <div class="form-group">
                                                 <label class="col-md-3 control-label" for="val_date2">To</label>
                                                <div class="col-md-8 col-xs-11">
                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                <h2><strong>Refund View</strong> Report</h2>
                            </div>
                            ...
                            <table class="table table-vcenter table-striped table-bordered button_margin123">
                                ...
                                <tbody>
                                    ...
                                    <td></td>
                                    <td>
                                        <a type="submit" class="btn btn-success">True</a><br><br>
                                        <a type="submit" name="deactive" value="" class="btn btn-danger ">False</a><br><br></td>
